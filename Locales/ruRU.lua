...
L["RandomWords"] = { ---- не может быть только одной записи
	...
	"В общей сложности игроки провели в мирах World of Warcraft более 1.000.000 лет. Что в среднем составляет 30 дней онлайна на человека. На самом же деле – гораздо больше",
	...
	"Известны случаи, когда слишком долгая игра приводила к фатальным последствиям. Так, в октябре 2005 года умерла от истощения китайская девочка после многосуточной игры в World of Warcraft",
	"На юге восточного континента раньше находилось 2 острова, которые были удалены из финальной версии игры — остров Джиллиджим и остров Доктора Лапидоса",
