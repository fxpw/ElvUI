...
L["BoU"] = "ПпИ"
L["Boss Frames"] = "Боссы"
L["Nameplate Frames"] = "Неймплейт фреймы"
L["Buffs"] = "Баффы"
...
L["Mythic+ Rating:"] = "M+ Рейтинг:"
L["Mythic+ Rating"] = "M+ Рейтинг"
L["Mythic+"] = "M+ Рейтинг"
L["Display Mythic+ rating in tooltip when hovering over a player."] = "Отображать Mythic+ рейтинг в подсказке при наведении на игрока."
...
L["Displays <AFK> if the Unit is afk"] = "Отображает <Отсутствует> если юнит отошел"
L["Displays <AFK>"] = "Отображает <afk> если юнит отошел"
