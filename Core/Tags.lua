...
E.TagInfo = {
	...
	["classcolor:priest"] = {category = L["Colors"], description = L[""]},
	["classcolor:druid"] = {category = L["Colors"], description = L[""]},
	["classcolor:paladin"] = {category = L["Colors"], description = L[""]},
	["classcolor:warrior"] = {category = L["Colors"], description = L[""]},
	["classcolor:mage"] = {category = L["Colors"], description = L[""]},
	["classcolor:rogue"] = {category = L["Colors"], description = L[""]},
	["classcolor:shaman"] = {category = L["Colors"], description = L[""]},
	["classcolor:deathknight"] = {category = L["Colors"], description = L[""]},
	["classcolor:warlock"] = {category = L["Colors"], description = L[""]},
	["classcolor:hunter"] = {category = L["Colors"], description = L[""]},
	["classcolor:player"] = {category = L["Colors"], description = L[""]},
	["healthcolorcustom"] = {category = L["Colors"], description = L[""]},
	["powercolorcustom"] = {category = L["Colors"], description = L[""]},
	--Classification
	...
	["health:percent:hidefull:hidedead"] = {category = L["Health"], description = L[""]},
	["health:current-percent:hidedead"] = {category = L["Health"], description = L[""]},
	["health:current:hidedead"] = {category = L["Health"], description = L[""]},
	["health:percent:hidedead"] = {category = L["Health"], description = L[""]},
	["health:current-percent:hidefull:hidedead"] = {category = L["Health"], description = L[""]},
	["health:current:hidefull:hidedead"] = {category = L["Health"], description = L[""]},
	...
	["levelcustom"] = {category = L["Level"], description = L[""]},
	["levelcustom:difficulty"] = {category = L["Level"], description = L[""]},
	--Mana
	...
	["name:long:abbreviate"] = {category = L["Names"], description = L[""]},
	["name:abbreviate"] = {category = L["Names"], description = L[""]},
	["name:veryshort:abbreviate"] = {category = L["Names"], description = L[""]},
	["name:short:abbreviate"] = {category = L["Names"], description = L[""]},
	["name:caps"] = {category = L["Names"], description = L[""]},
	["name:medium:abbreviate"] = {category = L["Names"], description = L[""]},
	--Party and Raid
	...
	["power:current:hidefull:hidezero"] = {category = L["Power"], description = L[""]},
	["power:current-percent:hidefull:hidedead"] = {category = L["Power"], description = L[""]},
	["power:current-percent:hidedead"] = {category = L["Power"], description = L[""]},
	["power:current-percent:hidefull:hidezero"] = {category = L["Power"], description = L[""]},
	["power:percent:hidefull"] = {category = L["Power"], description = L[""]},
	["power:percent:hidefull:hidezero"] = {category = L["Power"], description = L[""]},
	["power:current:hidezero"] = {category = L["Power"], description = L[""]},
	["power:percent:hidedead"] = {category = L["Power"], description = L[""]},
	["power:percent:hidezero"] = {category = L["Power"], description = L[""]},
	["power:current:hidedead"] = {category = L["Power"], description = L[""]},
	["power:percent:hidefull:hidedead"] = {category = L["Power"], description = L[""]},
	["power:current:hidefull:hidedead"] = {category = L["Power"], description = L[""]},
	["power:current-percent:hidefull"] = {category = L["Power"], description = L[""]},
	["power:current:hidefull"] = {category = L["Power"], description = L[""]},
	["power:current-percent:hidezero"] = {category = L["Power"], description = L[""]},
	--Realm
	...
	["num:targeting"] = {category = L["Target"], description = L[""]},
	--Threat
