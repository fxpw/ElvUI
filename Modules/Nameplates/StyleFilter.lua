...
-- Исправление для русских имен тотемов
local function FixRussianTotemNames()
	if not mod or not mod.Totems then return end

	-- Список всех вариантов имен тотемов
	local totemNameVariants = {
		-- Тотем силы земли
		["Тотем силы Земли"] = "e5",
		["Тотем силы Земли II"] = "e5",
		["Тотем силы Земли III"] = "e5",
		["Тотем силы Земли IV"] = "e5",
		["Тотем силы Земли V"] = "e5",
		["Тотем силы Земли VI"] = "e5",
		["Тотем силы Земли VII"] = "e5",
		["Тотем силы Земли VIII"] = "e5",

		-- Тотем защиты от сил природы
		["Тотем сопротивления силам природы"] = "a2",
		["Тотем защиты от магии природы II"] = "a2",
		["Тотем защиты от магии природы III"] = "a2",
		["Тотем защиты от магии природы IV"] = "a2",
		["Тотем защиты от магии природы V"] = "a2",
		["Тотем защиты от магии природы VI"] = "a2",

		-- Тотем защиты от огня
		["Тотем сопротивления силам стихий"] = "w2",
		["Тотем защиты от магии огня"] = "w2",
		["Тотем защиты от магии огняI"] = "w2",
		["Тотем защиты от магии огня IV"] = "w2",
		["Тотем защиты от магии огня V"] = "w2",
		["Тотем защиты от магии огня VI"] = "w2",

		-- Тотем защиты от магии льда
		["Тотем сопротивления льду"] = "f3",
		["Тотем сопротивления льду II"] = "f3",
		["Тотем сопротивления льду III"] = "f3",
		["Тотем сопротивления льду IV"] = "f3",
		["Тотем сопротивления льду V"] = "f3",
		["Тотем сопротивления льду VI"] = "f3",
	}

	-- Добавляем все варианты в таблицу тотемов
	for name, id in pairs(totemNameVariants) do
		mod.Totems[name] = id
	end
end
