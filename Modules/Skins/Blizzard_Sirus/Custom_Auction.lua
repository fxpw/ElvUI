...
--frames
	...
	-- AuctionHouseMultisellProgressFrameProgressBar:HookScript("OnShow",function(self)
	...
	-- end)
	-- hooksecurefunc(AuctionHouseMultisellProgressFrameProgressBar,'OnShow',function(self)
