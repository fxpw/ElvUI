...
local function LoadSkin()
	...
	WatchFrameHeaderMinimizeButton.tex:SetInside()
	WatchFrameHeaderMinimizeButton:SetHighlightTexture("Interface\\Buttons\\UI-PlusButton-Hilight", "ADD")
	WatchFrameHeaderMinimizeButton:SetFrameStrata("MEDIUM")
	...
	hooksecurefunc("WatchFrame_Collapse", function()
		WatchFrameHeaderMinimizeButton.tex:SetTexture(E.Media.Textures.PlusButton)
