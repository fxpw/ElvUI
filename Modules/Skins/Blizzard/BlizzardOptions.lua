...
S:AddCallback("Skin_BlizzardOptions", function()
	...
	local checkboxes = {
		...
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedEnable",
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedAbbrNumbers",
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedAtBase",
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedOutline",
		...
		"InterfaceOptionsObjectivesPanelInstanceEncounters",
		"InterfaceOptionsNamePlatePanelNewNamePlate",
		"InterfaceOptionsNamePlatePanelPredictedHealthAndPower",
		"InterfaceOptionsNamePlatePanelMakeDynamicScale",
		"InterfaceOptionsNamePlatePanelMakeDynamicAlpha",
		"InterfaceOptionsNamePlatePanelClassColorInFriendly",
		"InterfaceOptionsNamePlatePanelNameClassColorInFriendly",
		"InterfaceOptionsNamePlatePanelShowDebuffsOnFriendly",
		"InterfaceOptionsNamePlatePanelOtherAtBase",
		"InterfaceOptionsNamePlatePanelPersonalResource",
		"InterfaceOptionsNamePlatePanelPersonalClickThrough",
		"InterfaceOptionsNamePlatePanelPersonalResourceShowAlways",
		"InterfaceOptionsNamePlatePanelPersonalResourceShowInCombat",
		"InterfaceOptionsNamePlatePanelPersonalResourceOnEnemy",
	...
	local sliders = {
		...
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedScale",
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedOffsetY",
		"InterfaceOptionsCombatTextPanelWorldTextEnhancedDuration",
		"InterfaceOptionsNamePlatePanelMaxDistance",
		"InterfaceOptionsNamePlatePanelOffsetY",
		"InterfaceOptionsNamePlatePanelHorizontalScale",
		"InterfaceOptionsNamePlatePanelVerticalScale",
		"InterfaceOptionsNamePlatePanelGlobalScale",
		"InterfaceOptionsNamePlatePanelSelectedScale",
		"InterfaceOptionsNamePlatePanelOccludedAlphaMult",
		"InterfaceOptionsNamePlatePanelSelectedAlpha",
		"InterfaceOptionsNamePlatePanelNonSelectedAlpha",
		"InterfaceOptionsNamePlatePanelSelfAlpha",
		"InterfaceOptionsNamePlatePanelPersonalOffsetY",
		"InterfaceOptionsNamePlatePanelPersonalResourceTopInset",
	}
	...
	local dropdowns = {
		...
		"InterfaceOptionsNamePlatePanelShowOnlyNames",
		"InterfaceOptionsNamePlatePanelTargetRadialPosition",
		"InterfaceOptionsNamePlatePanelPersonalResourceShowWithTarget",
	}
