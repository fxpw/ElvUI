...
function UF:Raid25SmartVisibility(event)
	...
	if not InCombatLockdown() then
		...
		if instanceType == "raid" or instanceType == "pvp" then
			...
			if maxPlayers >= 11 and maxPlayers <= 25 then
				self:Show()
...
function UF:Update_Raid25Header(header, db)
	...
	if not headerHolder.positioned then
		...
		E:CreateMover(headerHolder, headerHolder:GetName().."Mover", L["Raid-25"], nil, nil, nil, "ALL,RAID", nil, "unitframe,raid25,generalGroup")
