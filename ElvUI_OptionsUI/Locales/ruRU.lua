...
L["Add a Name to the list."] = "Добавить имя в список"
...
L["Alerts"] = "Оповещения"
L["Allow LBF to handle the skinning of this element."] = "Разрешить Lib Button Facade обрабатывать этот элемент."
...
L["Arrow X-Offset"] = "Cмещение по x"
L["Arrow Y-Offset"] = "Cмещение по y"
...
L["Channel Alerts"] = "Предупреждения каналов"
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Измените ширину и контролируют, насколько большая область на экране будет принимать клики по целевым юнитам."
...
L["Controls how many seconds of inactivity has to pass before chat is faded."] = "Контролирует, сколько секунд неактивности должно пройти, прежде чем чат исчезнет."
L["Cooldown Orientation"] = "Ориентация текста восстановлению"
...
L["Display an exclamation mark on items that starts a quest."] = "Покажите восклицательный знак на предметах, которые начинают квест."
...
L["Display reminder bar on the minimap."] = "Дисплей напоминания на миникарте"
...
L["Displayed server time."] = "Отображаемое время сервера."
...
L["Down"] = "Вниз"
L["Dropdown CheckBox Skin"] = "Скин на выпадающий список"
...
L["Enemy NPC Frames"] = "Фремы вражеских NPC"
L["Enemy Player Frames"] = "Фремы вражеских игроков"
L["Enemy"] = "Враг"
L["Engineering"] = "Инженерия"
L["Enhanced PVP Messages"] = "Улучшенные PvP сообщения"
L["Equipped Item Color"] = "Цвет надетого предмета"
...
L["Fader"] = "Затухание"
L["Fades the buttons that toggle chat windows when that window has been toggled off."] = "Затухание кнопки, которые переключают окна чата, когда это окно было выключено."
...
L["Friendly NPC Frames"] = "Фреймы дружественных NPC"
L["Friendly Player Frames"] = "Фреймы дружественных игроков"
...
L["If enabled then the filter will activate if the unit is casting anything."] = "Если включено, то фильтр будет активируется, если юнит что-либо кастует."
L["If enabled then the filter will activate if the unit is channeling anything."] = "Если включено, то фильтр будет активируется, если юнит что-либо кастует(потоковое)."
L["If enabled then the filter will activate if the unit is not casting anything."] = "Если включено, то фильтр будет активируется, если юнит что-либо не кастует."
L["If enabled then the filter will activate if the unit is not channeling anything."] = "Если включено, то фильтр будет активируется, если юнит что-либо не кастует(потоковое)."
...
L["If enabled then the filter will only activate when you have a target."] = "Если включено, то фильтр будет активироваться только тогда, когда у вас будет цель."
...
L["LBF Support"] = "Поддержка Lib Button Facade"
L["LEVEL_BOSS"] = "Установите на -1 для боссов или 0 для отключения."
L["LFD Frame"] = "Поиск данжей"
...
L["Magic Effect"] = "Магический эффект"
...
L["Pick Up Action Key"] = "Кнопка взятия"
...
L["Position"] = "Позиция"
L["Position_Hided"] = "Позиция когда скрыто"
...
L["Require All"] = "Все"
L["Require Target"] = "Требовать цели"
...
L["Show Quest Icon"] = "Показывать иконку квеста"
...
L["Unique Units"] = "Уникальные юниты"
...
L["X-Offset_Hided"] = "Отступ по X когда скрыто здоровье"
L["Y-Offset"] = "Отступ по Y"
L["Y-Offset_Hided"] = "Отступ по Y когда скрыто здоровье"
...
"percent" - значение в процентах c %
"percent-nosign" - значение в процентах без %
...
"nosign" - отображает значение без сокращений.
...
L["ShowWhenHPHidden"] = "Показывать кастбар при скрытом здоровье"
L["LeftMiniPanel"] = "Левая панель (у карты)"
